    ...
    return (
        <Modal
            ...
            <div>
                ...
                <div className="user-profile-pic-edit">
                ...
                <div className="user-cover-pic-edit">
                ...
                {user.jobs.map((job , index)=>
                    <div className="intro-section" key={index}>
                        ...
                        {typeof job !== 'string' && <span>{job.position ? <strong>{job.position}</strong> : job.is_current ? 'Works' : 'Worked'} at <strong>{job.company}</strong></span>}
                    </div>
                )}
                {user.academics.map((academic, index) =>
                    <div className="intro-section" key={index}>
                        ...
                        {typeof academic !== 'string' && <span>{academic.is_current ? 'Studies' : 'Studied'} at <strong>{academic.school}</strong></span>}
                    </div>
                )}
