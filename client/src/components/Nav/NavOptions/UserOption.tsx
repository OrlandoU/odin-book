...
export default function UserOption(props: Props): JSX.Element {
    const { setToken } = useContext(TokenContext) as Token
    const user = useContext(UserContext) as User

    const handleDarkMode: ChangeEventHandler<HTMLInputElement> = (e) => {
    ...
    const handleCompactMode: ChangeEventHandler = (e) => {
        const target = e.target as HTMLInputElement
        if (target.value === 'on') {
