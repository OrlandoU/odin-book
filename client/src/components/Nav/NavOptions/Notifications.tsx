...
export default function Notifications(): JSX.Element {
    ...
    const [newNotifications, setNewNotifications] = useState<NotificationI[]>([])
    ...
    const handleSocket = useCallback(()=>{
        const newNotificationHandler = (notification: NotificationI) => {
            let isNew = true
        ...
        const removeNotificationHandler = (notification: NotificationI) => {
